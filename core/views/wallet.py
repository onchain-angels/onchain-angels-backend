...
class WalletSerializer(serializers.ModelSerializer):
    ...
    farcaster_handle = serializers.CharField(max_length=50, required=False, allow_null=True)
    twitter_handle = serializers.CharField(max_length=50, required=False, allow_null=True)

    class Meta:
        model = Wallet
        fields = ["id", "address", "farcaster_handle", "twitter_handle", "portfolio"]
